...
namespace GenieClient
{
    public class ComponentRichTextBox : RichTextBox
    {
        ...
        private bool m_bHideShowScrollbar = false; // Hide/Show scrollbar
        private bool m_bHideShowTitleBar = false; // Hide/show titlebar
        ...
        public bool HideShowScrollbar // Hide/Show scrollbar
        {
            get
            {
                return m_bHideShowScrollbar;
            }

            set
            {
                m_bHideShowScrollbar = value;
            }
        }
        ...
        public bool HideShowTitleBar // Hide/Show titlebar
        {
            get
            {
                return m_bHideShowTitleBar;
            }

            set
            {
                m_bHideShowTitleBar = value;
            }
        }
